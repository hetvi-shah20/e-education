...
<div class="kt-content  kt-content--fit-top  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
    <div class="kt-container ">
        <div class="row">
            @foreach($registration as $register_institute)
            <div class="col-lg-3">
                                ...
                                <div class="kt-widget__content">
                                    <div class="kt-widget__section">
                                        ...
                                        <div class="kt-widget__action">
                                           <a href="{{route('instituteregistrationprofile',$register_institute->id)}}"> <button type="button" class="btn btn-outline-primary">View Profile</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
