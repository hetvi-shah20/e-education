...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // return view('institute.pages.dashboard.test',['chart' => $chart]);
        return view('admin.pages.dashboard.dashboard',['chart' => $chart,'piechart' => $piechart],compact('count_collage_registration','count_pending_collage_registration','count_school_registration','count_pending_school_registration','count_institute_registration','count_pending_institute_registration','total_registration'))->with('user',$user);
    }
    ...
    public function getinstitute()
    {
        ...
        return view('admin.pages.dashboard.allInstituteprofile',compact('registration','user'));
    }
    ...
    public function getschool()
    {
        ...
        return view('admin.pages.dashboard.allSchoolprofile',compact('registration_school','user'));
    }
}
